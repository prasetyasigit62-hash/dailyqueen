...
// Legacy (pre-redesign) mall directory. Still used by all NON-Queen-City branches so the new
// design + Maps stay scoped to Queen City (MALL_ID=1) only. Do not delete — other malls depend on it.
export default function LegacyMallDirectory({ mallDirectory }: mallDirectoryProps) {
